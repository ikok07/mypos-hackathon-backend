...
import { getProfileUseCase } from "../../application/use-cases/auth/profiles/get-profile.use-case.ts";
import { deleteProfileUseCase } from "../../application/use-cases/auth/profiles/delete-profile.use-case.ts";
import { createProfileUseCase } from "../../application/use-cases/auth/profiles/create-profile.use-case.ts";
...
export function createProfilesModule() {
    ...
    profilesModule
        ...
        .toHigherOrderFunction(getProfileUseCase, [
